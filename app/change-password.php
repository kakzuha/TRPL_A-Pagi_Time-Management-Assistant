...
$tampil = mysqli_query($koneksi, "SELECT * FROM user WHERE email = '$email' and password = '$password'");

// $tampil = mysqli_query($koneksi, "SELECT * FROM user WHERE user_id = 'email' AND password = '$password'");
...
if ($data) {
    ...
    if ($password_baru == $konfirmasi_password) {
        ...
        $ubah = mysqli_query($koneksi, "UPDATE user SET password = '$password_ok' WHERE email = '$email'");
